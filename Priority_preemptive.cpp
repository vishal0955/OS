...
// It is used to reorder the heap according to  priority if the processes after insertion 
 of new process. 
...
// This function is responsible for executing  the highest priority extracted from Heap[]. 
